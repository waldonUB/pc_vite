/*
 * @Author: ADI
 * @Date: 2021-03-23 15:18:37
 * @LastEditors: ADI
 * @LastEditTime: 2021-03-23 15:25:48
 */
const ctx = 'tsclickoutside';
const nodeList = [];
let seed = 0;
let startClick;
...
export const tsclickoutside = {
  ...
  bind(el, binding, vnode) {
    // 一个元素只能绑定一次离开指令 如果有相同的，就直接去掉，再把当前的put进去
    const targetIndex = nodeList.indexOf(el);
    if (targetIndex >= 0) {
